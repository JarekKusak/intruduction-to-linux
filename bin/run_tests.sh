...
base_cache_dir="${HOME}/.cache/mff_nswi177_2023/"
tests_repository="https://gitlab.mff.cuni.cz/teaching/nswi177/2023/common/tests.git"
...
if [ $# -eq 0 ]; then
    rc=0
    "${repository_cache_dir}/run.sh" all
else
